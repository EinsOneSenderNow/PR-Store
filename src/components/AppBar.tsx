        ...
        <div className="w-full max-w-5xl h-16 bg-slate-950/80 backdrop-blur-xl rounded-2xl relative shadow-lg shadow-black/20 border border-slate-800/50">
          ...
          <div className="h-full px-4 sm:px-6 flex items-center justify-between relative">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link
                to="/showcase"
                className="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white border border-slate-700 hover:border-slate-500 rounded-full transition-all duration-300"
              >
                Витрина
              </Link>
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium bg-blue-600 hover:bg-blue-500 text-white rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 cursor-pointer"
              >
                Заказать
              </button>
